...
export class Guild {
  ...
  mythicRanged: string[] = ['Hezbolah', 'Gingerbrows', 'Revërie', 'Calissta', 'Halapeño', 'Supplicant', 'Lepickle'];
  mythicMelee: string[] = ['Dasan', 'Knutè', 'Kirelion', 'Sçythér', 'Supbae', 'Djeckt', 'Bigdoss', 'Twinslayerzz'];
